---
title: 'Chapter 1: Anatomy of an SVG'
author: Maya Gans
date: '2020-05-28'
...
I'm reading [Sarah Drasner's SVG Animations]() book and thought that blogging a summary of each chapter will help cement what I learn! My goal for the end of the book is to create a blockly like front end where blocks can be clicked together, nested, and move together in groups.

But for now **SVG Anatomy!**
...
I'm still a little confused about how and when to alter the viewBox versus the element's height and width directly, but hopefully this will make more sense as I read on....