...
# The R Way
R's stregnth is in dealing with vectors, so leverage that in the approach! [Jon Harmon](https://twitter.com/JonTheGeek) suggested a better approach for this problem.
```{r}
    n = 15
    dplyr::tibble(
    iteration = seq_len(n),
