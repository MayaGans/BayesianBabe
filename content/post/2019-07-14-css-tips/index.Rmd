...
*[Taking the internet's word for it on that one...]*
...
If you specify `auto` rather than a number, then the track will scale with the browser size. I used this within the second column below
