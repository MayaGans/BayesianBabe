...
Create a for loop for n iterations where every third iteration prints "buzz" and every fifth iteration prints "feed". Every combination prints "buzz-feed". Print the iterator for all other values.
