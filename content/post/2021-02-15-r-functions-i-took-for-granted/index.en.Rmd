...
In this post I'm focusing on base R functions because I can write an entire tome on tidyverse functions and `ggplot2`.... In short thank your local R developer, and push yourself to write these functions in other languages! 

Have any other vectorized operations you'd like to add? Find me on [twitter](www.twitter.com/mayacelium) I'd love to add it! 
