...
An R4DS bookclub discussion and companion to [Advanced R](https://adv-r.hadley.nz/rcpp.html#acknowledgments) and supplement to [Advanced R Solutions](https://advanced-r-solutions.rbind.io/names-and-values.html#copy-on-modify). [The repository for the group can be found here](https://github.com/r4ds/bookclub-Advanced_R) -- feel free to contribute answers or your own questions!
